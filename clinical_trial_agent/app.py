...
import json
import docx
from agent import run_gatekeeper, run_extractor, run_mapper, execute_deterministic_patient_search
...
with tab1:
    ...
    def render_gatekeeper_stage(file_content):
        # =====================================================================
    ...
    # Execute the Gatekeeper stage logic
    render_gatekeeper_stage(file_content)

    def render_extractor_stage():
        # =====================================================================
    ...
    # Execute the Extractor stage logic
    render_extractor_stage()

    def render_mapper_stage():
        # =====================================================================
        # STEP 2.5: Run Mapper
        # =====================================================================
    ...
    # Execute the Mapper stage logic
    render_mapper_stage()

    def render_data_engine_stage():
        # =====================================================================
        # STEP 3.5: Run Query
        # =====================================================================
        if st.session_state.workflow_step == 3.5:
            with st.spinner("🔍 **Agent 3: Data Engine** — Executing deterministic Pandas query..."):
                result = execute_deterministic_patient_search(st.session_state.workflow_data["mapper_result"]["mapped_json"])
    ...
    # Execute the Data Engine and Results stage logic
    render_data_engine_stage()
...
with tab2:
    ...
    # Guard Clause: Invert condition and exit early (Law 1: Avoid Deep Nesting)
    if not data_loaded:
